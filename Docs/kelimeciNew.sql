...
--
-- Host: localhost
-- Generation Time: Sep 23, 2011 at 11:26 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='kelimenin anlamlarını ve cümlelerini tutar' AUTO_INCREMENT=3836 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='kelimenin eş anlamlarını tutar' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='kelime ile kelimenin türünün bağlarını tutar' AUTO_INCREMENT=158 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='kelimeyle ilgili sayfanın html verisini tutar' AUTO_INCREMENT=218 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci COMMENT='etimoloji,okunuşu,dil v.b. bilgiler tutulur' AUTO_INCREMENT=160 ;
...
ALTER TABLE `meanings`
  ...
  ADD CONSTRAINT `fk_meanings_2` FOREIGN KEY (`clsId`) REFERENCES `classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `wordClasses`
  ADD CONSTRAINT `fk_wordClasses_1` FOREIGN KEY (`clsId`) REFERENCES `classes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
